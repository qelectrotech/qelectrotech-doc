...
The term project inside QElectroTech can be assimilated to a "dababase". A project is not a common database,
it is a collection of information which is not structurated in columns and rows.

.. figure:: ../images/qet_project_structure.png
   :align: center
...
properties, properties which define the way how should be represented each folio (`title block`_, dimensions, 
