.. _en/element/elementeditor/elementparts/ellipse
...
The ellipse can only be added to the workspace by the tool bar.
    ...
    2. Click at the workspace the position from the ellipse center point.
    3. Click at the workspace the position from on of the control point of the ellipse.
...
.. figure:: graphics/qet_element_ellipse.png
   :align: center
