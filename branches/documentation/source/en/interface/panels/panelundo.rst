.. _en/interface/panels/panelundo

==========
Undo panel
==========

The Undo panel displays the history since the last time that the document was saved. Once the project is 
saved undo panel is automaticall cleaned.
